...
public class INFINIDATaddHostToClusterTask extends AbstractTask {
	static Logger logger = Logger.getLogger(INFINIDATaddHostToClusterTask.class);

	@Override
	public void executeCustomAction(CustomActionTriggerContext context, CustomActionLogger actionlogger) throws Exception {
		logger.info( "----#### INFINIDATaddHostToClusterTask:executeCustomAction ####---- CONTEXT: " + context );

    	long configEntryId = context.getConfigEntry().getConfigEntryId();
    	INFINIDATaddHostToClusterTaskConfig config = (INFINIDATaddHostToClusterTaskConfig) context.loadConfigObject();
	...
	public TaskConfigIf getTaskConfigImplementation() {
		return new INFINIDATaddHostToClusterTaskConfig();
	}
	@Override
	public String getTaskName() {
		return INFINIDATaddHostToClusterTaskConfig.displayLabel;
	}
	@Override
