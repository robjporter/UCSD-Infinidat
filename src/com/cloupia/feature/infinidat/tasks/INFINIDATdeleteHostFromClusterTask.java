...
public class INFINIDATdeleteHostFromClusterTask extends AbstractTask {
	static Logger logger = Logger.getLogger(INFINIDATdeleteHostFromClusterTask.class);

	@Override
	public void executeCustomAction(CustomActionTriggerContext context, CustomActionLogger actionlogger) throws Exception {
		logger.info( "----#### INFINIDATdeleteHostFromClusterTask:executeCustomAction ####---- CONTEXT: " + context );

    	long configEntryId = context.getConfigEntry().getConfigEntryId();
    	INFINIDATdeleteHostFromClusterTaskConfig config = (INFINIDATdeleteHostFromClusterTaskConfig) context.loadConfigObject();
	...
	public TaskConfigIf getTaskConfigImplementation() {
		return new INFINIDATdeleteHostFromClusterTaskConfig();
	}
	@Override
	public String getTaskName() {
		return INFINIDATdeleteHostFromClusterTaskConfig.displayLabel;
	}
	@Override
