...
public class INFINIDATaddPortToHostTask extends AbstractTask {
	static Logger logger = Logger.getLogger(INFINIDATaddPortToHostTask.class);
	
    @Override
    public void executeCustomAction(CustomActionTriggerContext context, CustomActionLogger actionlogger) throws Exception {
    	logger.info( "----#### INFINIDATaddPortToHostTaskConfig:executeCustomAction ####---- CONTEXT: " + context );
    	
		long configEntryId = context.getConfigEntry().getConfigEntryId();
		//retrieving the corresponding config object for this handler
		INFINIDATaddPortToHostTaskConfig config = (INFINIDATaddPortToHostTaskConfig) context.loadConfigObject();
	...
	public TaskConfigIf getTaskConfigImplementation() {
		...
		return new INFINIDATsnapshotVolumeTaskConfig();
	}
	@Override
	public String getTaskName() {
		// TODO Auto-generated method stub
		return INFINIDATsnapshotVolumeTaskConfig.displayLabel;
	}
}