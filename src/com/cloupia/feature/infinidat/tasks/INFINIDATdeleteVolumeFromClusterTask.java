...
public class INFINIDATdeleteVolumeFromClusterTask extends AbstractTask {
	static Logger logger = Logger.getLogger(INFINIDATdeleteVolumeFromClusterTask.class);

	@Override
	public void executeCustomAction(CustomActionTriggerContext context, CustomActionLogger actionlogger) throws Exception {
		logger.info( "----#### INFINIDATdeleteVolumeFromClusterTask:executeCustomAction ####---- CONTEXT: " + context );

    	long configEntryId = context.getConfigEntry().getConfigEntryId();
    	INFINIDATdeleteVolumeFromClusterTaskConfig config = (INFINIDATdeleteVolumeFromClusterTaskConfig) context.loadConfigObject();
	...
	public TaskConfigIf getTaskConfigImplementation() {
		return new INFINIDATdeleteVolumeFromClusterTaskConfig();
	}
	@Override
	public String getTaskName() {
		return INFINIDATdeleteVolumeFromClusterTaskConfig.displayLabel;
	}
	@Override
