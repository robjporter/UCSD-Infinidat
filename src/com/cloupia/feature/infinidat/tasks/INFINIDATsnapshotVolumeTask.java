...
public class INFINIDATsnapshotVolumeTask extends AbstractTask {
	static Logger logger = Logger.getLogger(INFINIDATsnapshotVolumeTask.class);
	
    @Override
    public void executeCustomAction(CustomActionTriggerContext context, CustomActionLogger actionlogger) throws Exception {
    	logger.info( "----#### INFINIDATsnapshotVolumeTask:executeCustomAction ####---- CONTEXT: " + context );
