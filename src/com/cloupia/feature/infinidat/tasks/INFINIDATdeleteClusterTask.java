...
public class INFINIDATdeleteClusterTask extends AbstractTask {
	static Logger logger = Logger.getLogger(INFINIDATdeleteClusterTask.class);

	@Override
	public void executeCustomAction(CustomActionTriggerContext context, CustomActionLogger actionlogger) throws Exception {
		logger.info( "----#### INFINIDATdeleteClusterTask:executeCustomAction ####---- CONTEXT: " + context );

    	long configEntryId = context.getConfigEntry().getConfigEntryId();
    	INFINIDATdeleteClusterTaskConfig config = (INFINIDATdeleteClusterTaskConfig) context.loadConfigObject();
	...
	public TaskConfigIf getTaskConfigImplementation() {
		return new INFINIDATdeleteClusterTaskConfig();
	}
	@Override
	public String getTaskName() {
		return INFINIDATdeleteClusterTaskConfig.displayLabel;
	}
	@Override
