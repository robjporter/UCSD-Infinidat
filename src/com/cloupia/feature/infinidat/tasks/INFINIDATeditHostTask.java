...
public class INFINIDATeditHostTask extends AbstractTask {
	static Logger logger = Logger.getLogger(INFINIDATeditHostTask.class);

    @Override
    public void executeCustomAction(CustomActionTriggerContext context, CustomActionLogger actionlogger) throws Exception {
    	logger.info( "----#### INFINIDATeditHostTask:executeCustomAction ####---- CONTEXT: " + context );
    	
		long configEntryId = context.getConfigEntry().getConfigEntryId();
		//retrieving the corresponding config object for this handler
		INFINIDATeditHostTaskConfig config = (INFINIDATeditHostTaskConfig) context.loadConfigObject();
	...
	public TaskConfigIf getTaskConfigImplementation() {
		...
		return new INFINIDATeditHostTaskConfig();
	}
	@Override
	public String getTaskName() {
		// TODO Auto-generated method stub
		return INFINIDATeditHostTaskConfig.displayLabel;
	}
}