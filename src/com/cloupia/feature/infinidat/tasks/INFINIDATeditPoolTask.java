...
public class INFINIDATeditPoolTask extends AbstractTask {
	static Logger logger = Logger.getLogger(INFINIDATeditPoolTask.class);

    @Override
    public void executeCustomAction(CustomActionTriggerContext context, CustomActionLogger actionlogger) throws Exception {
    	logger.info( "----#### INFINIDATeditPoolTask:executeCustomAction ####---- CONTEXT: " + context );
    	
		long configEntryId = context.getConfigEntry().getConfigEntryId();
		//retrieving the corresponding config object for this handler
		INFINIDATeditPoolTaskConfig config = (INFINIDATeditPoolTaskConfig) context.loadConfigObject();
	...
	public TaskConfigIf getTaskConfigImplementation() {
		...
		return new INFINIDATeditPoolTaskConfig();
	}
	@Override
	public String getTaskName() {
		// TODO Auto-generated method stub
		return INFINIDATeditPoolTaskConfig.displayLabel;
	}
}