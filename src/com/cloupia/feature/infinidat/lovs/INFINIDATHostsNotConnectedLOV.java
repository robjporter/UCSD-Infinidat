...
public class INFINIDATHostsNotConnectedLOV  implements TabularReportGeneratorIf {
	private static Logger logger = Logger.getLogger( INFINIDATHostsNotConnectedLOV.class );
	public static final String HOSTS_TABULAR_PROVIDER = "infinidat_hosts_not_connected_tabular_provider";
	...
	public TabularReport getTabularReportReport( ReportRegistryEntry reportEntry, ReportContext context ) throws Exception {
		...
		if(elements.length == 2) {
			accName = elements[0];
			id = elements[1];
			logger.info( "----#### INFINIDATHostsNotConnectedLOV:getTabularReportReport ####---- ID: " + id );
			logger.info( "----#### INFINIDATHostsNotConnectedLOV:getTabularReportReport ####---- ACCNAME: " + accName );
		}
		...
		logger.info( "----#### INFINIDATHostsNotConnectedLOV:getTabularReportReport ####---- COUNT: " + count );
		...
		for( int i = 0; i < count; i++ ) {
			...
			logger.info( "----#### INFINIDATHostsNotConnectedLOV:getTabularReportReport ####---- ID: " + hid );
			logger.info( "----#### INFINIDATHostsNotConnectedLOV:getTabularReportReport ####---- NAME: " + name );
			logger.info( "----#### INFINIDATHostsNotConnectedLOV:getTabularReportReport ####---- CLUSTER: " + clusterid );
