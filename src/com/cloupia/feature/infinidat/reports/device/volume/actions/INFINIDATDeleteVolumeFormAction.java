...
public class INFINIDATDeleteVolumeFormAction extends CloupiaPageAction {
	private static Logger logger = Logger.getLogger(INFINIDATDeleteVolumeFormAction.class);
	...
	public void definePage(Page page, ReportContext context) {		
		page.bind(formId,INFINIDATDeleteVolumeForm.class);
	}
	...
	public void loadDataToPage(Page page, ReportContext context, WizardSession session) throws Exception {
		...
		INFINIDATDeleteVolumeForm form = new INFINIDATDeleteVolumeForm();
