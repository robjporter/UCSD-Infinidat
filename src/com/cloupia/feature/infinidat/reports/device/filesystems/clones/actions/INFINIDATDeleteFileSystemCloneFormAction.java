package com.cloupia.feature.infinidat.reports.device.filesystems.clones.actions;
...
public class INFINIDATDeleteFileSystemCloneFormAction extends CloupiaPageAction {
	private static Logger logger = Logger.getLogger(INFINIDATDeleteFileSystemCloneFormAction.class);
	private static final String formId = "infinidat.filesystem.clone.delete.report.action.form.DeleteFileSystem";
	private static final String ACTION_ID = "infinidat.filesystem.clone.delete.report.form.action.DeleteFileSystem";
	private static final String ACTION_LABEL = "Delete Clone";
	private static final String ACTION_DESCRIPTION = "Delete Filesystem Clone";
	...
	public void definePage(Page page, ReportContext context) {
		page.bind( formId, INFINIDATDeleteFileSystemCloneForm.class);
	}
	@Override
	public void loadDataToPage(Page page, ReportContext context, WizardSession session) throws Exception {
		...
		INFINIDATDeleteFileSystemCloneForm form = new INFINIDATDeleteFileSystemCloneForm();
